...
const (
	Shop_Greet_FullMethodName = "/stream.Shop/greet"
)
...
func (c *shopClient) Greet(ctx context.Context, in *GoodsReq, opts ...grpc.CallOption) (*GoodsResp, error) {
	out := new(GoodsResp)
	err := c.cc.Invoke(ctx, Shop_Greet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShopServer interface {
	Greet(context.Context, *GoodsReq) (*GoodsResp, error)
...
func (UnimplementedShopServer) Greet(context.Context, *GoodsReq) (*GoodsResp, error) {
...
func _Shop_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GoodsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShopServer).Greet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Shop_Greet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShopServer).Greet(ctx, req.(*GoodsReq))
	}
