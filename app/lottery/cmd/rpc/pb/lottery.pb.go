...
type Lottery struct {
	...
	PublishType   int64  `protobuf:"varint,5,opt,name=publishType,proto3" json:"publishType,omitempty"`     //寮€濂栬缃細1鎸夋椂闂村紑濂?2鎸変汉鏁板紑濂?3鍗虫娊鍗充腑
	PublishTime   int64  `protobuf:"varint,6,opt,name=publishTime,proto3" json:"publishTime,omitempty"`     //寮€濂栨椂闂?  int64 joinNumber = 7; //鑷姩寮€濂栦汉鏁?  string introduce = 8; //鎶藉璇存槑
	AwardDeadline int64  `protobuf:"varint,9,opt,name=awardDeadline,proto3" json:"awardDeadline,omitempty"` //棰嗗鎴鏃堕棿
	...
	IsSelected    int64  `protobuf:"varint,12,opt,name=isSelected,proto3" json:"isSelected,omitempty"`      //鏄惁绮鹃€?1鏄?0鍚?
}
...
type AddLotteryReq struct {
	...
	PublishType   int64  `protobuf:"varint,4,opt,name=publishType,proto3" json:"publishType,omitempty"`     //寮€濂栬缃細1鎸夋椂闂村紑濂?2鎸変汉鏁板紑濂?3鍗虫娊鍗充腑
	PublishTime   int64  `protobuf:"varint,5,opt,name=publishTime,proto3" json:"publishTime,omitempty"`     //寮€濂栨椂闂?  int64 joinNumber = 6; //鑷姩寮€濂栦汉鏁?  string introduce = 7; //鎶藉璇存槑
...
type UpdateLotteryReq struct {
	...
	PublishTime   int64  `protobuf:"varint,6,opt,name=publishTime,proto3" json:"publishTime,omitempty"`     //寮€濂栨椂闂?  int64 joinNumber = 7; //鑷姩寮€濂栦汉鏁?  string introduce = 8; //鎶藉璇存槑
	AwardDeadline int64  `protobuf:"varint,9,opt,name=awardDeadline,proto3" json:"awardDeadline,omitempty"` //棰嗗鎴鏃堕棿
	IsSelected    int64  `protobuf:"varint,10,opt,name=isSelected,proto3" json:"isSelected,omitempty"`      //鏄惁绮鹃€?1鏄?0鍚?}
}
...
type SearchLotteryReq struct {
	...
	PublishType   int64  `protobuf:"varint,7,opt,name=publishType,proto3" json:"publishType,omitempty"`      //寮€濂栬缃細1鎸夋椂闂村紑濂?2鎸変汉鏁板紑濂?3鍗虫娊鍗充腑
	PublishTime   int64  `protobuf:"varint,8,opt,name=publishTime,proto3" json:"publishTime,omitempty"`      //寮€濂栨椂闂?  int64 joinNumber = 9; //鑷姩寮€濂栦汉鏁?  string introduce = 10; //鎶藉璇存槑
	AwardDeadline int64  `protobuf:"varint,11,opt,name=awardDeadline,proto3" json:"awardDeadline,omitempty"` //棰嗗鎴鏃堕棿
	...
	IsSelected    int64  `protobuf:"varint,14,opt,name=isSelected,proto3" json:"isSelected,omitempty"`       //鏄惁绮鹃€?1鏄?0鍚?}
}
...
type Prize struct {
	...
	Count      int64  `protobuf:"varint,5,opt,name=count,proto3" json:"count,omitempty"`           //濂栧搧浠芥暟
	GrantType  int64  `protobuf:"varint,6,opt,name=grantType,proto3" json:"grantType,omitempty"`   //濂栧搧鍙戞斁鏂瑰紡锛?蹇€掗偖瀵?2璁╀腑濂栬€呰仈绯绘垜 3涓鑰呭～鍐欎俊鎭?4璺宠浆鍒板叾浠栧皬绋嬪簭
...
type AddPrizeReq struct {
	...
	Count     int64  `protobuf:"varint,4,opt,name=count,proto3" json:"count,omitempty"`         //濂栧搧浠芥暟
	GrantType int64  `protobuf:"varint,5,opt,name=grantType,proto3" json:"grantType,omitempty"` //濂栧搧鍙戞斁鏂瑰紡锛?蹇€掗偖瀵?2璁╀腑濂栬€呰仈绯绘垜 3涓鑰呭～鍐欎俊鎭?4璺宠浆鍒板叾浠栧皬绋嬪簭
}
...
var file_lottery_proto_rawDesc = []byte{
	...
	0x02, 0x70, 0x62, 0x22, 0xa5, 0x02, 0x0a, 0x07, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x12,
	...
	0x68, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x61, 0x77, 0x61, 0x72, 0x64, 0x44, 0x65,
	0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x61, 0x77,
	0x61, 0x72, 0x64, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63,
	...
	0x73, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0a, 0x69, 0x73, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x22, 0xdb, 0x01, 0x0a, 0x0d,
	0x41, 0x64, 0x64, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a,
	...
	,
	...
	,
	...
	0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x22, 0xd8, 0x02, 0x0a, 0x10, 0x53, 0x65, 0x61, 0x72, 0x63,
	...
	0x73, 0x68, 0x54, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x70, 0x75,
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x54, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x75, 0x62,
	0x6c, 0x69, 0x73, 0x68, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b,
	0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x61,
	0x77, 0x61, 0x72, 0x64, 0x44, 0x65, 0x61, 0x64, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x0b, 0x20, 0x01,
	...
	0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x69, 0x73, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65,
	0x64, 0x22, 0x3a, 0x0a, 0x11, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4c, 0x6f, 0x74, 0x74, 0x65,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x12, 0x25, 0x0a, 0x07, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72,
	0x79, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x4c, 0x6f, 0x74,
	0x74, 0x65, 0x72, 0x79, 0x52, 0x07, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x22, 0xd1, 0x01,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18,
	...
	0x65, 0x22, 0x87, 0x01, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x50, 0x72, 0x69, 0x7a, 0x65, 0x52, 0x65,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1c, 0x0a,
	0x09, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x09, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0x0e, 0x0a, 0x0c, 0x41,
	0x64, 0x64, 0x50, 0x72, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x9a, 0x01, 0x0a, 0x0e,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x71, 0x12, 0x0e,
	...
	0x61, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x67,
	...
	0x7a, 0x65, 0x22, 0x84, 0x02, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x50, 0x72, 0x69,
	0x7a, 0x65, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20,
	...
	0x1c, 0x0a, 0x09, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x49, 0x64, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x09, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x49, 0x64, 0x12, 0x12, 0x0a,
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07,
	...
	,
	...
	0x50, 0x72, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70,
...
var file_lottery_proto_depIdxs = []int32{
	...
	11, // 2: pb.GetPrizeByIdResp.prize:type_name -> pb.Prize
	11, // 3: pb.SearchPrizeResp.prize:type_name -> pb.Prize
	1,  // 4: pb.lottery.AddLottery:input_type -> pb.AddLotteryReq
	3,  // 5: pb.lottery.UpdateLottery:input_type -> pb.UpdateLotteryReq
	5,  // 6: pb.lottery.DelLottery:input_type -> pb.DelLotteryReq
	7,  // 7: pb.lottery.GetLotteryById:input_type -> pb.GetLotteryByIdReq
	9,  // 8: pb.lottery.SearchLottery:input_type -> pb.SearchLotteryReq
	12, // 9: pb.lottery.AddPrize:input_type -> pb.AddPrizeReq
	14, // 10: pb.lottery.UpdatePrize:input_type -> pb.UpdatePrizeReq
	16, // 11: pb.lottery.DelPrize:input_type -> pb.DelPrizeReq
	18, // 12: pb.lottery.GetPrizeById:input_type -> pb.GetPrizeByIdReq
	20, // 13: pb.lottery.SearchPrize:input_type -> pb.SearchPrizeReq
	2,  // 14: pb.lottery.AddLottery:output_type -> pb.AddLotteryResp
	4,  // 15: pb.lottery.UpdateLottery:output_type -> pb.UpdateLotteryResp
	6,  // 16: pb.lottery.DelLottery:output_type -> pb.DelLotteryResp
	8,  // 17: pb.lottery.GetLotteryById:output_type -> pb.GetLotteryByIdResp
	10, // 18: pb.lottery.SearchLottery:output_type -> pb.SearchLotteryResp
	13, // 19: pb.lottery.AddPrize:output_type -> pb.AddPrizeResp
	15, // 20: pb.lottery.UpdatePrize:output_type -> pb.UpdatePrizeResp
	17, // 21: pb.lottery.DelPrize:output_type -> pb.DelPrizeResp
	19, // 22: pb.lottery.GetPrizeById:output_type -> pb.GetPrizeByIdResp
	21, // 23: pb.lottery.SearchPrize:output_type -> pb.SearchPrizeResp
