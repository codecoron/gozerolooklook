...
var file_lottery_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x65, 0x73, 0x22, 0xfd, 0x01, 0x0a, 0x05, 0x50, 0x72, 0x69, 0x7a, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x7a, 0x65, 0x32, 0xca, 0x05, 0x0a, 0x07, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x12, 0x33,
	...
	0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x12, 0x2d, 0x0a, 0x08, 0x41, 0x64, 0x64, 0x50, 0x72, 0x69,
...
var file_lottery_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_lottery_proto_goTypes = []interface{}{
	...
	(*AddPrizeReq)(nil),              // 16: pb.AddPrizeReq
	(*AddPrizeResp)(nil),             // 17: pb.AddPrizeResp
	(*UpdatePrizeReq)(nil),           // 18: pb.UpdatePrizeReq
	(*UpdatePrizeResp)(nil),          // 19: pb.UpdatePrizeResp
	(*DelPrizeReq)(nil),              // 20: pb.DelPrizeReq
	(*DelPrizeResp)(nil),             // 21: pb.DelPrizeResp
	(*GetPrizeByIdReq)(nil),          // 22: pb.GetPrizeByIdReq
	(*GetPrizeByIdResp)(nil),         // 23: pb.GetPrizeByIdResp
	(*SearchPrizeReq)(nil),           // 24: pb.SearchPrizeReq
	(*SearchPrizeResp)(nil),          // 25: pb.SearchPrizeResp
}
var file_lottery_proto_depIdxs = []int32{
	15, // 0: pb.AddLotteryReq.prizes:type_name -> pb.Prize
	...
	15, // 4: pb.LotteryDetailResp.prizes:type_name -> pb.Prize
	15, // 5: pb.GetPrizeByIdResp.prize:type_name -> pb.Prize
	15, // 6: pb.SearchPrizeResp.prize:type_name -> pb.Prize
	...
	16, // 14: pb.lottery.AddPrize:input_type -> pb.AddPrizeReq
	18, // 15: pb.lottery.UpdatePrize:input_type -> pb.UpdatePrizeReq
	20, // 16: pb.lottery.DelPrize:input_type -> pb.DelPrizeReq
	22, // 17: pb.lottery.GetPrizeById:input_type -> pb.GetPrizeByIdReq
	24, // 18: pb.lottery.SearchPrize:input_type -> pb.SearchPrizeReq
	2,  // 19: pb.lottery.AddLottery:output_type -> pb.AddLotteryResp
	4,  // 20: pb.lottery.UpdateLottery:output_type -> pb.UpdateLotteryResp
	6,  // 21: pb.lottery.DelLottery:output_type -> pb.DelLotteryResp
	8,  // 22: pb.lottery.GetLotteryById:output_type -> pb.GetLotteryByIdResp
	10, // 23: pb.lottery.SearchLottery:output_type -> pb.SearchLotteryResp
	12, // 24: pb.lottery.SetIsSelectedLottery:output_type -> pb.SetIsSelectedLotteryResp
	14, // 25: pb.lottery.LotteryDetail:output_type -> pb.LotteryDetailResp
	17, // 26: pb.lottery.AddPrize:output_type -> pb.AddPrizeResp
	19, // 27: pb.lottery.UpdatePrize:output_type -> pb.UpdatePrizeResp
	21, // 28: pb.lottery.DelPrize:output_type -> pb.DelPrizeResp
	23, // 29: pb.lottery.GetPrizeById:output_type -> pb.GetPrizeByIdResp
	25, // 30: pb.lottery.SearchPrize:output_type -> pb.SearchPrizeResp
