...
var file_lottery_proto_rawDesc = []byte{
	...
	0x0c, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x74, 0x65, 0x64, 0x22, 0x8f, 0x03,
	...
	0xe5, 0x0e, 0x0a, 0x07, 0x6c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x12, 0x33, 0x0a, 0x0a, 0x41,
	...
	0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61,
	0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62,
...
var file_lottery_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_lottery_proto_goTypes = []interface{}{
	...
	(*ClockTask)(nil),                              // 51: pb.ClockTask
}
var file_lottery_proto_depIdxs = []int32{
	25, // 0: pb.AddLotteryReq.prizes:type_name -> pb.Prize
	51, // 1: pb.AddLotteryReq.clockTask:type_name -> pb.ClockTask
	...
	2,  // 34: pb.lottery.AddLottery:output_type -> pb.AddLotteryResp
	4,  // 35: pb.lottery.UpdateLottery:output_type -> pb.UpdateLotteryResp
	6,  // 36: pb.lottery.DelLottery:output_type -> pb.DelLotteryResp
	8,  // 37: pb.lottery.GetLotteryById:output_type -> pb.GetLotteryByIdResp
	10, // 38: pb.lottery.SearchLottery:output_type -> pb.SearchLotteryResp
	12, // 39: pb.lottery.SetIsSelectedLottery:output_type -> pb.SetIsSelectedLotteryResp
	14, // 40: pb.lottery.LotteryDetail:output_type -> pb.LotteryDetailResp
	16, // 41: pb.lottery.LotterySponsor:output_type -> pb.LotterySponsorResp
	18, // 42: pb.lottery.AnnounceLottery:output_type -> pb.AnnounceLotteryResp
	20, // 43: pb.lottery.CheckUserCreatedLottery:output_type -> pb.CheckUserCreatedLotteryResp
	22, // 44: pb.lottery.CheckUserCreatedLotteryAndToday:output_type -> pb.CheckUserCreatedLotteryAndTodayResp
	24, // 45: pb.lottery.CheckUserCreatedLotteryAndThisWeek:output_type -> pb.CheckUserCreatedLotteryAndThisWeekResp
	27, // 46: pb.lottery.AddPrize:output_type -> pb.AddPrizeResp
	29, // 47: pb.lottery.UpdatePrize:output_type -> pb.UpdatePrizeResp
	31, // 48: pb.lottery.DelPrize:output_type -> pb.DelPrizeResp
	33, // 49: pb.lottery.GetPrizeById:output_type -> pb.GetPrizeByIdResp
	35, // 50: pb.lottery.SearchPrize:output_type -> pb.SearchPrizeResp
	42, // 51: pb.lottery.GetPrizeListByLotteryId:output_type -> pb.GetPrizeListByLotteryIdResp
	37, // 52: pb.lottery.AddLotteryParticipation:output_type -> pb.AddLotteryParticipationResp
	40, // 53: pb.lottery.SearchLotteryParticipation:output_type -> pb.SearchLotteryParticipationResp
	44, // 54: pb.lottery.GetParticipationUserIdsByLotteryId:output_type -> pb.GetParticipationUserIdsByLotteryIdResp
	46, // 55: pb.lottery.CheckIsParticipated:output_type -> pb.CheckIsParticipatedResp
	48, // 56: pb.lottery.GetSelectedLotteryStatistic:output_type -> pb.GetSelectedLotteryStatisticResp
	50, // 57: pb.lottery.CheckSelectedLotteryParticipated:output_type -> pb.CheckSelectedLotteryParticipatedResp
