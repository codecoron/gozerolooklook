...
var file_lottery_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x3d, 0x0a, 0x1d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4c,
	...
	0x72, 0x79, 0x49, 0x64, 0x22, 0x8c, 0x01, 0x0a, 0x14, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79,
...
var file_lottery_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
...
var file_lottery_proto_depIdxs = []int32{
	...
	4,  // 27: pb.lottery.UpdateLottery:output_type -> pb.UpdateLotteryResp
	6,  // 28: pb.lottery.DelLottery:output_type -> pb.DelLotteryResp
	8,  // 29: pb.lottery.GetLotteryById:output_type -> pb.GetLotteryByIdResp
	10, // 30: pb.lottery.SearchLottery:output_type -> pb.SearchLotteryResp
	12, // 31: pb.lottery.SetIsSelectedLottery:output_type -> pb.SetIsSelectedLotteryResp
	14, // 32: pb.lottery.LotteryDetail:output_type -> pb.LotteryDetailResp
	16, // 33: pb.lottery.LotterySponsor:output_type -> pb.LotterySponsorResp
	18, // 34: pb.lottery.AnnounceLottery:output_type -> pb.AnnounceLotteryResp
	21, // 35: pb.lottery.AddPrize:output_type -> pb.AddPrizeResp
	23, // 36: pb.lottery.UpdatePrize:output_type -> pb.UpdatePrizeResp
