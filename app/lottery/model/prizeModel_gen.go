...
func (m *defaultPrizeModel) Insert(ctx context.Context, data *Prize) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.LotteryId, data.Type, data.Name, data.Count, data.GrantType)
	}, lotteryPrizeIdKey)
	return ret, err
}
...
func (m *defaultPrizeModel) Update(ctx context.Context, data *Prize) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.LotteryId, data.Type, data.Name, data.Count, data.GrantType, data.Id)
	}, lotteryPrizeIdKey)
	return err
}
